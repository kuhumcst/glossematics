...
return cljs.core._write(writer__5330__auto__,"reagent.impl.template/NativeWrapper");
}));
...
var G__37638 = o;
reagent.impl.template.goog$module$goog$object.set(G__37638,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__37721__i = 0, G__37721__a = new Array(arguments.length -  0);
while (G__37721__i < G__37721__a.length) {G__37721__a[G__37721__i] = arguments[G__37721__i + 0]; ++G__37721__i;}
  args = new cljs.core.IndexedSeq(G__37721__a,0,null);
} 
return G__37720__delegate.call(this,args);};
G__37720.cljs$lang$maxFixedArity = 0;
G__37720.cljs$lang$applyTo = (function (arglist__37722){
var args = cljs.core.seq(arglist__37722);
...
var G__37656 = o;
reagent.impl.template.goog$module$goog$object.set(G__37656,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__37663 = props;
var G__37663__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37663,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__37663);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37663__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37668 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37668,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37668;
}
})(),id_class);
...
var G__37676 = (cljs.core.count(argv) - first_child);
switch (G__37676) {
case (0):
...
return cljs.core._write(writer__5330__auto__,"reagent.impl.template/HiccupTag");
}));
...
var vec__37682 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37682,(2),null);
...
var temp__5808__auto___37743 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___37743 == null)){
} else {
var key_37745 = temp__5808__auto___37743;
(jsprops.key = key_37745);
}
...
var temp__5808__auto___37753 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___37753 == null)){
} else {
var key_37754 = temp__5808__auto___37753;
(jsprops.key = key_37754);
}
...
var temp__5808__auto___37770 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___37770 == null)){
} else {
var key_37775 = temp__5808__auto___37770;
(jsprops.key = key_37775);
}
...
var temp__5808__auto___37778 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___37778 == null)){
} else {
var key_37779 = temp__5808__auto___37778;
(jsprops.key = key_37779);
}
...
var temp__5808__auto___37781 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___37781 == null)){
} else {
var key_37782 = temp__5808__auto___37781;
(jsprops.key = key_37782);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37688_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37688_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37690 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37690,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37690,(1),null);
...
break;
default:
var G__37794 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37795 = compiler;
v = G__37794;
compiler = G__37795;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37706 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37706 = (function (opts,id,fn_to_element,parse_fn,meta37707){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37706.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37708,meta37707__$1){
var self__ = this;
var _37708__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37706(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta37707__$1));
}));

(reagent.impl.template.t_reagent$impl$template37706.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37708){
var self__ = this;
var _37708__$1 = this;
return self__.meta37707;
}));

(reagent.impl.template.t_reagent$impl$template37706.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37706.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37706.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template37706.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37706.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37706.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta37707","meta37707",-1274323843,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37706.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37706.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37706");

(reagent.impl.template.t_reagent$impl$template37706.cljs$lang$ctorPrWriter = (function (this__5329__auto__,writer__5330__auto__,opt__5331__auto__){
return cljs.core._write(writer__5330__auto__,"reagent.impl.template/t_reagent$impl$template37706");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37706.
 */
reagent.impl.template.__GT_t_reagent$impl$template37706 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37706(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37707){
return (new reagent.impl.template.t_reagent$impl$template37706(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta37707));
});

}

return (new reagent.impl.template.t_reagent$impl$template37706(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
