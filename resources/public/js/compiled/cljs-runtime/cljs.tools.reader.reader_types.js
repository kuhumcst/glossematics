...
return (m__5393__auto__.cljs$core$IFn$_invoke$arity$1 ? m__5393__auto__.cljs$core$IFn$_invoke$arity$1(reader) : m__5393__auto__.call(null,reader));
} else {
...
var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29702 = (function (reader){
var x__5392__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29702(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29703 = (function (reader,ch){
var x__5392__auto__ = (((reader == null))?null:reader);
var m__5393__auto__ = (cljs.tools.reader.reader_types.unread[goog.typeOf(x__5392__auto__)]);
if((!((m__5393__auto__ == null)))){
return (m__5393__auto__.cljs$core$IFn$_invoke$arity$2 ? m__5393__auto__.cljs$core$IFn$_invoke$arity$2(reader,ch) : m__5393__auto__.call(null,reader,ch));
} else {
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29703(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29704 = (function (reader){
var x__5392__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29704(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29706 = (function (reader){
var x__5392__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29706(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29707 = (function (reader){
var x__5392__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29707(reader);
}
});
...
return cljs.core._write(writer__5330__auto__,"cljs.tools.reader.reader-types/StringReader");
}));
...
return cljs.core._write(writer__5330__auto__,"cljs.tools.reader.reader-types/NodeReadableReader");
}));
...
return cljs.core._write(writer__5330__auto__,"cljs.tools.reader.reader-types/PushbackReader");
}));
...
return cljs.core._write(writer__5330__auto__,"cljs.tools.reader.reader-types/IndexingPushbackReader");
}));
...
return cljs.core._write(writer__5330__auto__,"cljs.tools.reader.reader-types/SourceLoggingPushbackReader");
}));
...
var G__29769 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29770 = s.append(c);
c = G__29769;
s = G__29770;
continue;
}
