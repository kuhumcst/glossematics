...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40995_SHARP_){
return ["%",lambdaisland.uri.platform.byte__GT_hex(p1__40995_SHARP_)].join('');
...
var encode_char = (function (p1__40996_SHARP_){
var G__41009 = p1__40996_SHARP_;
if(cljs.core.truth_(cljs.core.re_find(char_class,p1__40996_SHARP_))){
return lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$1(G__41009);
} else {
return G__41009;
}
});
...
return clojure.string.replace(s,/(%[0-9A-Fa-f]{2})+/,(function (p__41013){
var vec__41014 = p__41013;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41014,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41014,(1),null);
...
var G__41099 = (i + (3));
var G__41100 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(lambdaisland.uri.normalize.percent_decode(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (3)))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__41099;
res = G__41100;
continue;
} else {
...
var G__41102 = (i + (1));
var G__41103 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))));
i = G__41102;
res = G__41103;
continue;
} else {
var G__41104 = (i + (1));
var G__41105 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,lambdaisland.uri.normalize.percent_encode.cljs$core$IFn$_invoke$arity$2(cljs.core.subs.cljs$core$IFn$_invoke$arity$3(s,i,(i + (1))),new cljs.core.Keyword(null,"query","query",-1288509510)));
i = G__41104;
res = G__41105;
continue;
