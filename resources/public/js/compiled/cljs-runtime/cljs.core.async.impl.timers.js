...
return cljs.core._write(writer__5330__auto__,"cljs.core.async.impl.timers/SkipListNode");
}));
...
var i_30180 = (self__.level + (1));
while(true){
if((i_30180 <= (new_level + (1)))){
(update[i_30180] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_30183 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_30183[i]));
} else {
x__$2.forward.push((((i < links_30183.length))?(links_30183[i]):null));
}

if((i < links_30183.length)){
(links_30183[i] = x__$2);
} else {
links_30183.push(x__$2);
}
...
var i_30187 = (0);
while(true){
if((i_30187 <= self__.level)){
var links_30190 = (update[i_30187]).forward;
if((x__$1 === (((i_30187 < links_30190.length))?(links_30190[i_30187]):null))){
(links_30190[i_30187] = (x__$1.forward[i_30187]));

var G__30191 = (i_30187 + (1));
i_30187 = G__30191;
continue;
} else {
var G__30193 = (i_30187 + (1));
i_30187 = G__30193;
continue;
}
} else {
...
var G__30195 = nx;
var G__30196 = (level__$1 - (1));
x = G__30195;
level__$1 = G__30196;
continue;
} else {
var G__30197 = x;
var G__30198 = (level__$1 - (1));
x = G__30197;
level__$1 = G__30198;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__30206 = nx;
var G__30207 = (level__$1 - (1));
x = G__30206;
level__$1 = G__30207;
continue;
} else {
var G__30212 = x;
var G__30213 = (level__$1 - (1));
x = G__30212;
level__$1 = G__30213;
continue;
}
...
return cljs.core._write(writer__5330__auto__,"cljs.core.async.impl.timers/SkipList");
}));
