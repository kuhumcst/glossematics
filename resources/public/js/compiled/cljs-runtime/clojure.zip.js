...
var G__40998 = clojure.zip.node(loc);
var fexpr__40997 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__40997.cljs$core$IFn$_invoke$arity$1 ? fexpr__40997.cljs$core$IFn$_invoke$arity$1(G__40998) : fexpr__40997.call(null,G__40998));
});
/**
...
var G__41005 = clojure.zip.node(loc);
var fexpr__41004 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__41004.cljs$core$IFn$_invoke$arity$1 ? fexpr__41004.cljs$core$IFn$_invoke$arity$1(G__41005) : fexpr__41004.call(null,G__41005));
} else {
...
var fexpr__41010 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__41010.cljs$core$IFn$_invoke$arity$2 ? fexpr__41010.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__41010.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__41019 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41019,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41019,(1),null);
var vec__41022 = clojure.zip.children(loc);
var seq__41023 = cljs.core.seq(vec__41022);
var first__41024 = cljs.core.first(seq__41023);
var seq__41023__$1 = cljs.core.next(seq__41023);
var c = first__41024;
var cnext = seq__41023__$1;
var cs = vec__41022;
...
var vec__41028 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41028,(0),null);
var map__41031 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41028,(1),null);
var map__41031__$1 = cljs.core.__destructure_map(map__41031);
var path = map__41031__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41031__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41031__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41031__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41031__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41031__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__41038 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41038,(0),null);
var map__41041 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41038,(1),null);
var map__41041__$1 = cljs.core.__destructure_map(map__41041);
var path = map__41041__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41041__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__41042 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41041__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var seq__41043 = cljs.core.seq(vec__41042);
var first__41044 = cljs.core.first(seq__41043);
var seq__41043__$1 = cljs.core.next(seq__41043);
var r = first__41044;
var rnext = seq__41043__$1;
var rs = vec__41042;
...
var vec__41051 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41051,(0),null);
var map__41054 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41051,(1),null);
var map__41054__$1 = cljs.core.__destructure_map(map__41054);
var path = map__41054__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41054__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41054__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return r;
} else {
...
var vec__41068 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41068,(0),null);
var map__41071 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41068,(1),null);
var map__41071__$1 = cljs.core.__destructure_map(map__41071);
var path = map__41071__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41071__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41071__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
...
var vec__41082 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41082,(0),null);
var map__41085 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41082,(1),null);
var map__41085__$1 = cljs.core.__destructure_map(map__41085);
var path = map__41085__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41085__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41085__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__5043__auto__ = path;
if(cljs.core.truth_(and__5043__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__41092 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41092,(0),null);
var map__41095 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41092,(1),null);
var map__41095__$1 = cljs.core.__destructure_map(map__41095);
var path = map__41095__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41095__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__41115 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41115,(0),null);
var map__41118 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41115,(1),null);
var map__41118__$1 = cljs.core.__destructure_map(map__41118);
var path = map__41118__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41118__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41124,(1),null);
...
var len__5768__auto___41384 = arguments.length;
var i__5769__auto___41386 = (0);
while(true){
if((i__5769__auto___41386 < len__5768__auto___41384)){
args__5774__auto__.push((arguments[i__5769__auto___41386]));

var G__41388 = (i__5769__auto___41386 + (1));
i__5769__auto___41386 = G__41388;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5775__auto__);
});
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq41135){
...
return self__5753__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41136,G__41137,seq41135__$2);
}));
...
var G__41413 = clojure.zip.rightmost(child);
loc__$1 = G__41413;
continue;
} else {
return loc__$1;
...
var vec__41231 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41231,(0),null);
var map__41234 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41231,(1),null);
var map__41234__$1 = cljs.core.__destructure_map(map__41234);
var path = map__41234__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41234__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41234__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41234__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41234__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__41447 = clojure.zip.rightmost(child);
loc__$1 = G__41447;
continue;
} else {
return loc__$1;
